    ...
    <div class="container my-4">
        ...
        <div class="container mt-4">
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <a href="placed_order.php" class="nav-link active">Placed Orders</a>
                </li>
                <li class="nav-item">
                ...
                <table class="table table-striped table-borderd table-hover">
                    ...
                    <tbody class="">
                        ...
                        <?php
                            ...
                            echo "<td><a href='placed_order.php?unapprove={$order_id}'>Unapprove</a></td>";
                            echo "<td>$order_payment</td>";
                            echo "<td>$order_address</td>";
                            echo "<td><a href='users.php?u_name={$order_user_id}'>$order_user_name</a></td>";
                            echo "<td>$order_date</td>";
                            echo "<td><a href='placed_order.php?delete={$order_id}' class='text-danger'>delete</a></td>";
                            echo " </tr>";
                        }
