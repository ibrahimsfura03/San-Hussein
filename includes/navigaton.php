...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    ...
    <form action="search.php" method="GET" class="inline-form d-sm-block">
        <div class="input-group">
            <input type="search" name="search" placeholder="Search products by description..." class="form-control form-control-sm">
